-- -- Project Employee and Departments
...
-- 2. Look at the creation of the tables above, you are going to improve those tables :
...
-- STEP TWO: INSERT ROWS

-- INSERT INTO DEPARTMENT VALUES ('FINANCE', 'EDINBURGH'),
--                               ('SOFTWARE','PADDINGTON'),
--                               ('SALES', 'MAIDSTONE'),
