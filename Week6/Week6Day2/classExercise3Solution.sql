-- CREATE SEQUENCE seq_ten INCREMENT 10 START 10;

-- CREATE TABLE department
-- (
--    Deptcode   INTEGER NOT NULL PRIMARY KEY DEFAULT nextval('seq_ten'),
--    DeptName   CHAR(30),
...
-- 6. Create a query that displays EMPFNAME, EMPLNAME, DEPTCODE, DEPTNAME, LOCATION from EMPLOYEE, and DEPARTMENT tables.
